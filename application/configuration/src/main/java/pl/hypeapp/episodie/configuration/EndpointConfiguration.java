...
import pl.hypeapp.episodie.entrypoints.rest.tvshow.getpremieres.GetTvShowPremieresEndpoint;
...
public class EndpointConfiguration {
    ...
    @Bean
    public GetTvShowPremieresEndpoint getTvShowPremieresEndpoint(GetPremieresUseCase getPremieresUseCase) {
        return new GetTvShowPremieresEndpoint(getPremieresUseCase);
    }
